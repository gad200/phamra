    ...
    <div class="container login-container">
      <div class="row">
        <div class="col-md-7 content-part">
          ...
          <h6 style="text-align:center;font-weight:bold;color:#3FA99E">Mohamed Elbakry Project</h4>
            <hr>
            ...
            <div class="col-lg-8 col-md-11  formcol mx-auto">
              ...
              if (isset($_POST['connect'])) {
                ...
                if ($nom != "" && $password != "") {
                  ...
                  $sql1 = "SELECT * FROM  admin where name_admin='$nom' and password_admin='$password' ";
