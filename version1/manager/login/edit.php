 <?php
  ...
  if (isset($_SESSION['id_admin'])) {
    $nom = $_SESSION['id_admin'];
    $sql1 = "SELECT * FROM manager where id_manager = '$nom'";
                 ...
                 <div class="col-lg-8 col-md-11  formcol mx-auto">
                   ...
                   <?php
                    ...
                    if (isset($_POST['edit'])) {
                      ...
                      $sql3 = "UPDATE manager SET name_manager='" . $_POST['nom'] . "',password_manager='" . $_POST['password'] . "'  WHERE id_manager='$idadm'  ";
