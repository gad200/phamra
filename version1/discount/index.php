        ...
        <body style="background-color: #222B32!important;">
            ...
            <main style="margin-top: 58px">
                            ...
                            <form method="post">
                                ...
                                <div class="form-group" style="text-align: center;">
                                    ...
                                    <select name="product_name" style="text-align: center;" id="select-state" placeholder="اختار الدواء">
                                        ...
                                        <?php
                                        $sql2 = "select * from products WHERE `id_user`=$idadm";
             ...
             //
                 ...
                 $sql4 = "SELECT s.id_product, s.id_client, p.id_product, p.product_name, p.product_image, c.num_client FROM client c
