    ...
    <body style="background-color: #222B32!important;">
        ...
        <nav id="sidebarMenu" class="collapse d-lg-block bg-white sidebar collapse ">
          <div class="position-sticky">
            <div class="list-group list-group-flush mx-3 mt-4">
              ...
              <a style="color: #3FA99E;font-weight:bold;" href="edit.php" class="list-group-item list-group-item-action py-2 ripple">
            ...
            <ul class="navbar-nav ms-auto d-flex flex-row">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                  <li><a style="color: #3FA99E;font-weight:bold;text-align:center" class="dropdown-item" href="edit.php">حسابي</a></li>
                  <li><a style="color: #3FA99E;font-weight:bold;text-align:center" class="dropdown-item" href="logout.php">تسجيل الخروج</a></li>
                </ul>
              </li>
            </ul>
          </div>
      ...
      <main style="margin-top: 58px">
        <div class="container pt-4">
          ...
          <h2 style="text-align: center;font-weight:bold;color: white;"> تعديل معلومات الحساب</h2>
          <br>
          <br>
          ...
          <div class="row">
            ...
            <div class="col-md-4" style="background-color: white;border-radius: 20px 20px 20px 20px ; padding: 20px 20px  20px 20px;">
              <form method="post">
                <!-- Email input -->
                <div class="form-outline mb-4">
                  <input type="text" name="nom" class="form-control" style="text-align: center;" placeholder="اسم المستخدم" />
                </div>

                <!-- Password input -->
                <div class="form-outline mb-4">
                  <input type="password" name="password" class="form-control" style="text-align: center;" placeholder="كلمة المرور" />
                </div>



                <!-- Submit button -->
                <button type="submit" name="edit" class="btn  btn-block" style="font-weight: bold;color:#3FA99E;font-size:17px">تعديل</button>
              </form>
              <?php
              ...
              if (isset($_POST['edit'])) {
                ...
                $sql3 = "UPDATE user SET nom_user='" . $_POST['nom'] . "',password_user='" . $_POST['password'] . "'  WHERE id_user='$idadm'  ";
