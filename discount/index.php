        ...
        <body style="background-color: #222B32!important;">
            ...
            <main style="margin-top: 58px">
                        ...
                        <div class="col-md-6" style="background-color: white;border-radius: 20px 20px 20px 20px ; padding: 20px 20px  20px 20px;">
                            <form method="post">
                                ...
                                <div class="form-group" style="text-align: center;">
                                    ...
                                    <select name="product_name" style="text-align: center;" id="select-state" placeholder="اختار المنتج">
                                        <option style="text-align: center;" value="">اختار المنتج</option>
                                        <?php
                                        ...
                                        if ($res2) {
                                            while ($rows2 = mysqli_fetch_assoc($res2)) {
                                                ?>
                                                <option style="text-align: center;" value="<?php echo $rows2['id_product'] ?>"><?php echo $rows2['product_name'] ?></option>
                                                <?php
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <button  style="text-align: center;color: #3FA99E;font-weight:bold;font-size:15px;"> <a href="dwa.php" class="button" >الادوية</a></button>
             ...
             //
                 ...
                 $sql4 = "SELECT DISTINCT  s.id_product, s.id_client, p.id_product, p.product_name, p.product_image, c.num_client FROM client c
    JOIN products p ON p.id_product= $id_product
    JOIN sales s ON s.id_client = c.id_client AND s.id_product = p.id_product";
                 ...
                 if ($res4 ) {
                     while ($rows4 = mysqli_fetch_assoc($res4)) {
                         ...
                         $product_name = $rows4['product_name'];
                         $product_image = $rows4['product_image'];
