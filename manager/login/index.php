    ...
    <div class="container login-container">
      <div class="row">
        <div class="col-md-7 content-part">
          ...
          <h4 style="text-align:center;font-weight:bold;color:#3FA99E">Mohamed Elbakry Project</h4>
            <hr>
            <h2> <img style="text-align:center;margin-bottom:15px" class="rounded-circle" src="../../login/1.jpg" alt="" width="250" height="250">
          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-md-11  formcol mx-auto">
              ...
              <h3 style="color: #3FA99E;font-weight:bold">تسجيل الدخول</h3>
                              ...
                              <a href="../../login/login.php"  <h3 style="color: #3FA99E;font-weight:bold">تسجيل الدخول كمشرف</h3></a>
              ...
              if (isset($_POST['connect'])) {
                ...
                if ($nom != "" && $password != "") {
                  ...
                  $sql1 = "SELECT * FROM  manager where name_manager='$nom' and password_manager='$password' ";
                  ...
                  if ($rc == 1) {
                    ...
                    session_start();
                    $idadmin = $rows['id_manager'];
                    $nomadmin = $rows['name_manager'];

                    $_SESSION['name_admin'] = $nom;
