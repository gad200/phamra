          ...
          <div class="position-sticky">
            <div class="list-group list-group-flush mx-3 mt-4">
              <a style="color: #3FA99E;font-weight:bold;" href=" index.php" class="list-group-item list-group-item-action py-2 ripple  " aria-current="true">
                ...
                <a style="color: #3FA99E;font-weight:bold;" href=" products/products.php" class="list-group-item list-group-item-action py-2 ripple  " aria-current="true">
      ...
      <main style="margin-top: 58px">
        <div class="container pt-4">
          ...
          <div class="container">
            ...
            <h2 style="text-align: center;font-weight:bold;color: white;">قائمة الادوية</h2>
            <br>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <h5 style="text-align: center;">اضافة دواء</h5>
                    <hr>
                    <form id="addUser" action="">
                      ...
                      <div class="mb-3 row">
                        <div class="col-md-12">
                          <p style="text-align: center;font-weight:bold"> اسم الدواء</p>

                          <input type="text" name="name" id="addUserField" class="form-control" style="text-align:center;">
                        </div>
                      </div>
