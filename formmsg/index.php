                    ...
                    <div class="position-sticky">
                        <div class="list-group list-group-flush mx-3 mt-4">
                            ...
                            <a style="color: #3FA99E;font-weight:bold;" href="index.php" class="list-group-item list-group-item-action py-2 ripple">
                                <i class="fas fa-euro-sign " style="color: #3FA99E;"></i><span> فورم الرسالة</span></a>
            ...
            <main style="margin-top: 58px">
                <div class="container pt-4">
                    ...
                    if (isset($_GET['d']) and  isset($_GET['id'])) {
                        $didf = $_GET['id'];
                        $sql7 = "DELETE FROM `form` WHERE `id_form`='$didf'";
                    ...
                    <br> <br>
                    <?php
                    $sql3 = "select * from form where id_user='$idadm' limit 1";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="text-align: center;">
                                        ...
                                        <table class="table" style="background-color: white;border-radius: 20px 20px 20px 20px ;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td> <a href="index.php?d=t&id=<?php echo $idf; ?>" class="btn btn-link btn-sm deleteBtn"><i style="color: #3FA99E;" class="fas fa-trash"></i></a></td>
                                                    <td><?php echo $rows3['text_form'] ?></td>
                                                </tr>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="text-align: center;">
                                    ...
                                    <h6 style="font-weight: bold;color:#3FA99E">شرح طريقة الكتابة</h6>
                                    <p>قم باضافة السمات الخاصة بالزبون عن طريق نسخها و لصقها في محتوى الرسالة </p>
                                    <span style="font-weight: bold;" class="text-danger"> و يجب عدم استعمال هذه السمات في الوصف الخاص بكم</span>
                                    <hr>
                                    <br>
                                    <p style="font-weight: bold;color:#3FA99E">مثال </p>

                                    <div class="row mb-4">
                                        <div class="col-md-12">
                                            <div class="form-outline">
                                                <input type="text" style="text-align: center;" value="اسم_العميل" disabled id="form3Example1" class="form-control" />
                                            </div>
                                        </div>
                                        <br>
                                         <div class="col-md-12"  style="margin-top:10px;">
                                            <div class="form-outline">
                                                <input type="text" style="text-align: center;" disabled value="رقم_العميل" id="form3Example2" class="form-control" />
                                            </div>
                                        </div>
                                        <br>
                                        <div class="col-md-12"  style="margin-top:10px;">
                                            <div class="form-outline">
                                                <input type="text" style="text-align: center;" disabled value="الدواء" id="form3Example2" class="form-control" />
                                            </div>
                                        </div>
                                       <div class="col-md-12"  style="margin-top:10px;">
                                            <div class="form-outline">
                                                <input type="text" style="text-align: center;" disabled value="عدد_الايام" id="form3Example2" class="form-control" />
                                            </div>
                                        </div>
                                         <div class="col-md-12"  style="margin-top:10px;">
                                            <div class="form-outline">
                                                <input type="text" style="text-align: center;" disabled value="عدد_الساعات" id="form3Example2" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <span style="text-align: center;">
                                        السلام عليكم هذا تذكير خاص بالعميل
                                        <span style="font-weight: bold;color:#3FA99E"> اسم_العميل </span>
                                        صاحب الرقم
                                        <span style="font-weight: bold;color:#3FA99E"> رقم_العميل </span>....
                                        يجب اخذ هذا الدواء
                                        <span style="font-weight: bold;color:#3FA99E"> الدواء </span>
                                        لمدة
                                        <span style="font-weight: bold;color:#3FA99E"> عدد_الايام </span>
                                        يوما
                                        كل
                                        <span style="font-weight: bold;color:#3FA99E"> عدد_الساعات </span>
                                        ساعة
                                        ... من اجل سلامتكم والشفاء الصحيح ... شكرا لكم
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            if (isset($_POST['send5'])) {
                                                ...
                                                $sql4 = "INSERT INTO `form`( `id_user`, `text_form`) VALUES ('$idadm','$msg')";
